...
void main(){
  ...
  if (uEnableRipples == 1) {
    for (int i = 0; i < MAX_CLICKS; ++i){
      ...
      float currentCellPixelSize = 8.0 * pixelSize;
      vec2 cuv = (((pos - uResolution * .5 - currentCellPixelSize * .5) / (uResolution))) * vec2(aspectRatio, 1.0);
  ...
  useEffect(() => {
    ...
    if (mustReinit) {
      ...
      const scheduleFrame = () => {
        ...
        if (threeRef.current) threeRef.current.raf = nextRaf
        return nextRaf
      }
